...
aws ecr describe-repositories --repository-names ${ORG_APP_NAME} 2>/dev/null || \
aws ecr create-repository --repository-name ${ORG_APP_NAME}
...
aws logs create-log-group --log-group-name "/ecs/${ORG_APP_NAME}" 2>/dev/null || true
